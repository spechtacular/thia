...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--cin", help="input csv file path", type=str, required=True
        )
        parser.add_argument(
            "--cout", help="output csv file path", type=str, required=True
        )
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    "Unicode decode error reading input csv file %s: %s", cin, e
                )
